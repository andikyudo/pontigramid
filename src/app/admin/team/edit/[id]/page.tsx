  ...
  const fetchTeamMember = async () => {
    try {
      ...
      if (data.success) {
        ...
        alert('Failed to fetch team member: ' + data.error);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        alert('Failed to update team member: ' + data.error);
      }
    } catch (error) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Memuat data anggota tim...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">
            Edit Anggota Tim Redaksi
          </h1>
          <p className="mt-2 text-gray-600">
            Edit informasi anggota tim redaksi
          </p>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                />
                <p className="text-sm text-gray-500 mt-1">
                  Urutan tampil di halaman tim redaksi
                </p>
              </div>
